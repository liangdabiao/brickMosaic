...
var getPartListOfOneSet = function (id) {
    switch (id) {
        case "Beatles":
            var partList = [
                [5, 19, 29, 708, 98138, 6284070], // r, g, b, count, type (98138 = tile, 6141 = stud, 3024 = 1x1 plate), element_id
				[255, 255, 255, 155, 98138, 6284572],
				[228, 205, 158, 286, 98138, 6284573],
				[254, 138, 24, 74, 98138, 6284582],
				[149, 138, 115, 142, 98138, 6322841],
				[88, 42, 18, 253, 98138, 6284586],
				[160, 165, 169, 51, 98138, 6284071],
				[108, 110, 104, 150, 98138, 6284596],
				[204, 112, 42, 29, 98138, 6284589],
				[248, 187, 61, 65, 98138, 6322822],
				[159, 195, 233, 57, 98138, 6322823],
				[10, 52, 99, 121, 98138, 6284584],
				[53, 33, 0, 558, 98138, 6322813],
				[96, 116, 161, 52, 98138, 6322842],
				[169, 85, 0, 85, 98138, 6322840]
				];
            return partList;
        case "Monroe":
            var partList = [
		...
		case "Sith":
            var partList = [
				[5, 19, 29, 895, 6141, 614126],
				[201, 26, 9, 290, 6141, 614121],
				[255, 255, 255, 193, 6141, 614101],
				[254, 138, 24, 125, 6141, 4157103],
				[160, 165, 169, 110, 6141, 4211525],
				[108, 110, 104, 160, 6141, 4210633],
				[87, 88, 87, 271, 6141, 6038201],
				[255, 240, 58, 92, 6141, 6319958],
				[10, 52, 99, 448, 6141, 6021623],
				[53, 33, 0, 210, 6141, 6315780],
				[114, 14, 15, 332, 6141, 6314247],
				[96, 116, 161, 143, 6141, 6315783]
				];
			return partList;
		case "Hogwarts":
            var partList = [
		...
		case "ArtProject":
            var partList = [
				[5, 19, 29, 266, 98138, 6284070],
				[201, 26, 9, 196, 98138, 6284574],
				[75, 159, 74, 153, 98138, 6353793],
				[242, 205, 55, 315, 98138, 6284577],
				[255, 255, 255, 493, 98138, 6284572],
				[228, 205, 158, 255, 98138, 6284573],
				[254, 138, 24, 140, 98138, 6284582],
				[187, 233, 11, 174, 98138, 6284583],
				[228, 173, 200, 58, 98138, 6284587],
				[88, 42, 18, 320, 98138, 6284586],
				[204, 112, 42, 294, 98138, 6284589],
				[248, 187, 61, 173, 98138, 6322822],
				[255, 240, 58, 120, 98138, 6343806],
				[10, 52, 99, 688, 98138, 6284584],
				[7, 139, 201, 128, 98138, 6322824],
...
function generatePDFTitlePage(pdf, timeString) {
	...
	// Footer
	pdf.setFontSize(11);
	pdf.text(30, pdfHeight - 20, 'Downloaded from  lego.348349.xyz ');
...
function generateImageTitlePage(ctx, offsetY, timeString) {
    ...
    ctx.textBaseline = "middle";
    ctx.fillText("Downloaded from  lego.348349.xyz", imgMm(30), H - imgMm(20) + offsetY);
